...
export default function Sidebar() {
  return (
    <nav className="sidebar">
      <a href="/" className="sidebar-logo" aria-label="Home">
        <span className="logo-n">N</span>
      </a>
      <a href="#search" className="sidebar-item" aria-label="Search">
      ...
      <a href="#notifications" className="sidebar-item" aria-label="Notifications">
      ...
      <a href="#mylist" className="sidebar-item" aria-label="My List">
      ...
      <a href="#browse" className="sidebar-item" aria-label="Browse">
